...
import { UNIT_ACTIONS } from '../utils/Constants';

export default class PlayerView extends THREE.Object3D {
  camera = null;
  skin = null;
  animationMixer = null;
  ...
  _loadModel = async () => {
    ...
    const gltf = await gltfLoader.loadAsync('Steve.glb');
  ...
  jump() {
    if (!this._isJumping) {
      ...
      this.playAnimation(UNIT_ACTIONS.TPose);
    }
  }
